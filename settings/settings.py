...
SECRET_KEY = 'django-insecure-vss)-y@=g9)sqrj6vmy+9t4x4i$k3dfr9^&_%v7k!y6eh#9xje'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'battle/static'),
    os.path.join(BASE_DIR, 'crm_customers/static'),
    os.path.join(BASE_DIR, 'crm_employees/static'),
]
...
EMAIL_HOST_PASSWORD = 'qAChUeOppyTanW4a'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
